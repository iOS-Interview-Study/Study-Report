...
| 주차 | 질문                                                    | 발표자 |
|------|-----------------------------------------------------------|--------|
| 5    |    UIKit 클래스들을 다룰 때 꼭 처리해야하는 애플리케이션 쓰레드 이름은 무엇인가?   |       |
| 5    |   앱이 시작할 때 main.c 에 있는 UIApplicationMain 함수에 의해서 생성되는 객체는 무엇인가?  |     |
| 5    | App thinning에 대해서 설명하시오. |     |
| 5    |      멀티 쓰레드로 동작하는 앱을 작성하고 싶을 때 고려할 수 있는 방식들을 설명하시오.    |    |
