...
| 3    | App의 Not running, Inactive, Active, Background, Suspended에 대해 설명하시오.     |  제임스    |
| 3    | 접근 제어자의 종류엔 어떤게 있는지 설명하시오. |   코지   |
| 3    | 모든 View Controller 객체의 상위 클래스는 무엇이고 그 역할은 무엇인가?                                |  페즈   |
